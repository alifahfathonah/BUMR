					...
					<ul class="nav navbar-nav m-l-n visible-xs">
						...
						echo"<li style='padding:1px 10px 10px 20px;'>					
							<div class'm-t-sm'>
								...
								<a rel='nofollow' href='map.html' class='btn btn-black btn-sm'> Lokasi Terdekat </a>
							</div>			
							</li>";
						}
						else{
						...
						<ul class='dropdown-menu animated fadeInDown' role='menu'>	
							...
							<li><a href='map.html'><span Lokasi Terdekat</span> </a></li>
                        ...
                        <form method="POST" action="result.php" class="navbar-form navbar-form-sm visible-xs visible-md visible-lg">
                            <div class="form-group">
                                <div class="input-group ">
                                    <input type="text" name="search" id="search" style='width: 500px;' class="form-control input-sm bg-light no-border padder" placeholder="Cari Produk">
...
$(document).ready(function() {
   ...
   $("#search").keyup(function() {
    ...
    <!-- bagian ini ada di tampilan taskbar #ybreza -->
                <ul class="nav navbar-nav nav-indicators ">
					<li>
                    ...
                    <li style="padding:1px 10px 10px 20px;">
                        <div class="m-t-sm">
                            <a rel="nofollow" href="sign-in.html" class="btn btn-black btn-sm ">Login</a>
                            <a rel="nofollow" href="sign-up.html" class="btn btn-sm btn-go m-r-xs">Daftar</a>
                            <a rel="nofollow" href="modul/map/map.php" class="btn btn-black btn-sm">Lokasi Terdekat &nbsp <img src="images/gps.png"></a>
                        </div>
                    </li>
                </ul>
				<?php } ?>
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------->
  <br>
<font color=black><h4>Syarat Dan Ketentuan</h4></font>

<p><font color=black>1. </font>     
<font color=black>BUMR sebagai sarana penunjang bisnis berusaha menyediakan berbagai fitur dan layanan untuk menjamin keamanan dan kenyamanan para penggunanya.</font></p>

 
 <p><font color=black>2. </font>   
 <font color=black>BUMR tidak berperan sebagai Pelapak barang, melainkan sebagai perantara antara Pelapak dan Pembeli</font></p>

    
 <p><font color=black>3. </font>  
 <font color=black>Barang-barang yang dapat diperdagangkan di BUMR merupakan barang yang tidak terdaftar sebagai "Barang Terlarang".</font></p> 

<p><font color=black>4. </font>  
 <font color=black>BUMR tidak bertanggung jawab atas kualitas barang, proses pengiriman, rusaknya reputasi pihak lain, dan/atau segala bentuk perselisihan yang dapat terjadi antar Pengguna.</font></p>    


 <p><font color=black>5. </font>   
 <font color=black>BUMR memiliki kewenangan untuk mengambil tindakan yang dianggap perlu terhadap akun yang diduga dan/atau terindikasi melakukan penyalahgunaan, memanipulasi, dan/atau melanggar Aturan Penggunaan di BUMR.</font></p>

 <p><font color=black>6. </font>   
 <font color=black> BUMR memiliki kewenangan untuk mengambil tindakan yang dianggap perlu terhadap akun Pengguna, mulai dari melakukan moderasi, menghentikan layanan "Jual Barang", membatasi jumlah pembuatan akun, membatasi atau mengakhiri hak setiap Pengguna untuk menggunakan layanan, maupun menutup akun tersebut tanpa memberikan pemberitahuan atau informasi terlebih dahulu kepada pemilik akun yang bersangkutan.</font></p>

 <p><font color=black>7. </font>   
 <font color=black>BUMR memiliki kewenangan untuk mengambil keputusan atas permasalahan yang terjadi pada setiap transaksi.</font></p>

    
 <p><font color=black>8. </font>   
 <font color=black>BUMR berhak meminta data-data pribadi Pengguna jika diperlukan.</font></p>

 <p><font color=black>9. </font>   
 <font color=black>Aturan Penggunaan BUMR dapat berubah sewaktu-waktu dan/atau diperbaharui dari waktu ke waktu tanpa pemberitahuan terlebih dahulu. Dengan mengakses BUMR, Pengguna dianggap menyetujui perubahan-perubahan dalam Aturan Penggunaan BUMR.</font></p>


<p><font color=black>10. </font>   
 <font color=black>Hati-hati terhadap penipuan yang mengatasnamakan BUMR. Untuk informasi Panduan Keamanan silakan klik di sini.</font></p>
