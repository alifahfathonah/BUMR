				...
				<div class="panel panel-default b-a">
					...
					<div class="col-sm-9">	
						<ul class='nav nav-tabs'>
							...
							<li><a href='#pwd' data-toggle='tab' class='text-sm'>Password</a></li>						
						</ul>		
						<div>
						...
						<div id='myTabContent' class='tab-content'>		
							...
							<div class='tab-pane fade' id='kurir'>
								<div class="panel-body link-info">								
									<form class="form-horizontal" action="action_update_courier.php" method="post" enctype="multipart/form-data">
										<?php
										$full_url = full_url();
										if (strpos($full_url, "?suc=ok") == TRUE){
											echo "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert'>&times;</a>
