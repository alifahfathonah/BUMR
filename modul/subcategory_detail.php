    ...
    <div class="container m-b-sm p-t-sm ">
					...
					?>
                        <div class="col-md-7">
							...
							<img class="thumb-xs m-r-md m-b-xs" src="images/product.png"><?php include "breadcumb.php"; ?></h1>
                            <!--<p class="text-black font-thin m-b-sm">Discover 257 Android Templates & Source Codes. These source codes feature full Android Studio or Eclipse projects that can be easily modified and used to create and launch your own Android app.</p>-->
                        </div>
            ...
            <div class="col-sm-3 m-b-lg">
					...
					<ul class="nav  nav-pills nav-stacked nav-sm text-black">
						...
						while($rowC=mysql_fetch_array($sqlC)){
							...
							if ($nums > 0){
								echo"<li>
									<a class='list-group-item' data-toggle='collapse' href='#$rowC[categorySeo]'>$rowC[categoryName] <i class='ion-android-arrow-dropdown'></i></a>
