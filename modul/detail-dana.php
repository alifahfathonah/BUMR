...
$query=mysql_query("SELECT * FROM withdraw A LEFT JOIN
					...
					WHERE A.customerID!='$_SESSION[useri]' AND A.withdrawID='$_GET[id]'
...
echo"
					...
					<div class='panel panel-default b-a'><div class='panel-heading'><span class='font-bold'>Pencairan</span></div>
					<div class='panel-body link-info'>";
						...
						{
							echo "<a class='icon-trues' href='tarik-dana-1-$row[withdrawID].html?date=$row[dateFinish]'>
