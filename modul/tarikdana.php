						...
						<div class='panel panel-default'>
							...
							echo"<div class='panel-body'>
									...
									<div class='form-group'>
										...
										<div class='col-lg-10'>
											<input class='form-control text-sm' type='text' name='dateFinish' value='$dana[dateFinish]' DISABLED>
									...
									<div class='form-group'>
										...
										<div class='col-lg-10'>
											<input class='form-control text-sm' type='text' onkeyup='calcPay();' id='tagDraw' name='tagDraw' value='$dana[tagDraw]' DISABLED>
											<span class='help-block'></span>
										</div>
									</div>		
									<div class='form-group'>
