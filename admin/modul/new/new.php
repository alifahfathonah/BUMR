  ...
  default:
	...
	?>
       <tr><td class='data' width='30px'><?php echo $no; ?></td>
			 ...
			 <td><?php echo $dtNew['dateSend']; ?></td>
			 <?php
				if($dtNew['statusOrder'] == 'Dibayar' ){
					echo "<td><span class='label label-warning'><i class='ion-clock'></i> Dibayar</span></td>";
				}
				elseif($dtNew['statusOrder'] == 'Dikirim' ){
					echo"<td><span class='label label-success'><i class='ion-paper-airplane'></i> Dikirim</span></td>";
				}
				elseif($dtNew['statusOrder'] == 'Pending' ){
			 ...
			 <td><a href='?app=new&act=editnew&id=<?php echo $dtNew['orderID']; ?>'><i class='ion-compose'></i> Edit</a> |
				<a href="<?php echo $aksi; ?>?app=new&act=hapus&id=<?php echo $dtNew['orderID']; ?>"  onClick="return confirm('Apakah Anda benar-benar mau menghapusnya ?');">
